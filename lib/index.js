    ...
    value: function startUpload(file) {
      ...
      Promise.resolve().then(function () {
        ...
        task.on('state_changed', function (snapshot) {
          return _this2.props.onProgress && _this2.props.onProgress(Math.round(100 * snapshot.bytesTransferred / snapshot.totalBytes), task);
        }, function (error) {
          return _this2.props.onUploadError && _this2.props.onUploadError(error, task);
        }, function () {
          _this2.removeTask(task);
          return _this2.props.onUploadSuccess && _this2.props.onUploadSuccess(task.snapshot.ref.name, task);
        });
